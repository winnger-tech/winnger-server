...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (transaction) => {
      ...
      await queryInterface.removeColumn('restaurants', 'taxInfo', { transaction });
      await queryInterface.removeColumn('restaurants', 'menuDetails', { transaction });
      await queryInterface.removeColumn('restaurants', 'hoursOfOperation', { transaction });
      ...
      await queryInterface.removeColumn('restaurants', 'paymentAmount', { transaction });
      await queryInterface.removeColumn('restaurants', 'paymentDate', { transaction });
      await queryInterface.removeColumn('restaurants', 'registrationStage', { transaction });
      await queryInterface.removeColumn('restaurants', 'businessDocumentUrl', { transaction });

      // Add index for currentStep
      await queryInterface.addIndex('restaurants', ['currentStep'], { transaction });
    });
  },
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.sequelize.transaction(async (transaction) => {
      // Remove new fields
      await queryInterface.removeColumn('restaurants', 'ownerAddress', { transaction });
      await queryInterface.removeColumn('restaurants', 'businessType', { transaction });
      await queryInterface.removeColumn('restaurants', 'businessEmail', { transaction });
      await queryInterface.removeColumn('restaurants', 'businessPhone', { transaction });
      await queryInterface.removeColumn('restaurants', 'restaurantAddress', { transaction });
      await queryInterface.removeColumn('restaurants', 'HSTNumber', { transaction });
      await queryInterface.removeColumn('restaurants', 'HSTdocumentUrl', { transaction });
      await queryInterface.removeColumn('restaurants', 'foodHandlingCertificateUrl', { transaction });
      await queryInterface.removeColumn('restaurants', 'articleofIncorporation', { transaction });
      await queryInterface.removeColumn('restaurants', 'articleofIncorporationExpiryDate', { transaction });
      await queryInterface.removeColumn('restaurants', 'foodSafetyCertificateExpiryDate', { transaction });
      await queryInterface.removeColumn('restaurants', 'currentStep', { transaction });
      await queryInterface.removeColumn('restaurants', 'completedSteps', { transaction });
