...
const emailTemplates = {
  ...
  applicationStatus: (type, status) => `
    ...
    ${status === 'approved' ? '<p>Congratulations! You can now proceed with the payment to complete your registration.</p>' : status === 'rejected' ? '<p>We regret to inform you that your application has been rejected. If you believe this is a mistake, please contact our support team.</p>' : ''}
  `,
  paymentReceipt: ({
    amount,
    transactionId,
