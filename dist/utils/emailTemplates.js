const emailTemplates = {
  ...
  applicationStatus: (type, status) => `
    ...
    ${status === 'approved' ? '<p>You can now log in to your account and start using our services.</p>' : status === 'rejected' ? '<p>If you believe this is a mistake, please contact our support team.</p>' : ''}
  `,
  adminNotification: ({
    type,
    businessName,
