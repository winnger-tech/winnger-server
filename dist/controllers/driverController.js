...
class DriverController extends BaseController {
  ...
  async uploadDriverDocuments(files) {
    const documentUrls = {};
    const requiredDocuments = ['profilePhoto', 'driversLicenseFront', 'driversLicenseBack', 'vehicleRegistration', 'vehicleInsurance', 'drivingAbstract', 'criminalBackgroundCheck',
    // ADDED
    'workEligibility'];
